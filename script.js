...
// grabbing sidebar button elements
let homeBtn = document.getElementById("home");
let socialsBtn = document.getElementById("socials");
let podcastBtn = document.getElementById("podcast");
let patreonBtn = document.getElementById("patreon");
let aboutBtn = document.getElementById("about");

// grabbing content-page elements
let homeContent = document.getElementById("home-main");
let socialsContent = document.getElementById("socials-main");
let podcastContent = document.getElementById("podcast-main");
let patreonContent = document.getElementById("patreon-main");
let aboutContent = document.getElementById("about-main");

// creating event listeners
homeBtn.onclick = () => {
    homeContent.hidden = false;
    socialsContent.hidden = true;
    podcastContent.hidden = true;
    patreonContent.hidden = true;
    aboutContent.hidden = true;
}

socialsBtn.onclick = () => {
    homeContent.hidden = true;
    socialsContent.hidden = false;
    podcastContent.hidden = true;
    patreonContent.hidden = true;
    aboutContent.hidden = true;
};
...
window.onload = function () {
    ...
    const view = (function (helpers) {
      ...
      function addBackGroundToCurrentIndex(index) {
        DOTS[index].style.background = "#F29727";
      }
